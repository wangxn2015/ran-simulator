...
type Message struct {
	indicationMessageItems []*e2smrcies.E2SmRcIndicationMessageFormat3Item
}
...
func WithMessageItems(indicationMessageItems []*e2smrcies.E2SmRcIndicationMessageFormat3Item) func(message *Message) {
...
func (message *Message) Build() (*e2smrcies.E2SmRcIndicationMessage, error) {
	indicationMessage, err := pdubuilder.CreateE2SmRcIndicationMessageFormat3(message.indicationMessageItems)
	if err != nil {
		return nil, err
	}
